    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('PATIENT', 'Patient / Customer'), ('PHARMACIST', 'Certified Pharmacist'), ('DOCTOR', 'Doctor / Healthcare Specialist'), ('ADMIN', 'Administrator')], default='PATIENT', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('message', models.TextField()),
                ('notification_type', models.CharField(choices=[('ORDER', 'Order Update'), ('PRESCRIPTION', 'Prescription Verification'), ('CONSULTATION', 'Doctor Consultation'), ('REFILL', 'Medication Refill Reminder'), ('SYSTEM', 'System Alert')], default='SYSTEM', max_length=20)),
